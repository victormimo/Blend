...
export const Chair = ({ orientation, handleSelectedSeat }) => {
  if (orientation === "right") {
    return (
      <Flex direction="row" align="center" onClick={handleSelectedSeat}>
    ...
    return (
      <Flex direction="column" align="center" onClick={handleSelectedSeat}>
